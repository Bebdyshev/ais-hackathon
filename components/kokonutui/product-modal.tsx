          ...
          <div className="p-3 md:w-3/5 flex flex-col">
            <div className="flex-1">
              <div className="flex justify-between items-start mb-2">
                ...
                <p className="text-sm font-medium">{product.price} points</p>
              </div>
            ...
            <button
              ...
              className="w-full mt-3 py-2 bg-green-600 text-white text-xs font-medium rounded-md hover:bg-green-700 transition-colors"
            >
              Add to Cart
            </button>
          </div>
